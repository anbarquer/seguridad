 ...
 * Permite gestionar los diferentes atributos que se almacenan: -M�scara
 * -Algoritmo -Salt
 *
 */
public class Header {
     ...
     * -Algoritmo: PBEWithMD5AndDES -Salt fija: {0x7d, 0x60, 0x43, 0x5f, 0x02,
     * 0xe9, 0xe0, 0xae}
     */
    public Header() {
    ...
    /**
     * Intenta cargar los datos de una cabecera desde un InputStream abierto. Si
